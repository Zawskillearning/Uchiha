...
PICS = (environ.get('PICS', 'https://image.zaw-myo.workers.dev/image/fd0efec8-2bab-4caf-9ede-1c62c9330663')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002247222921'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002247222921').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002247222921')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002247222921')).split()]  # For Multiple Id Use One Space Between Each.
